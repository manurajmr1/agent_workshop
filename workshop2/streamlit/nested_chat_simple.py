...
# Define the task
task = """Write a detailed and engaging product review for the new Meta VR headset. Keep it short and concise, focusing on the key features and user experience."""
